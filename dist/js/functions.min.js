(() => {
  ...
  __commonjs = {
    ...
    4() {
      ...
      __require(335 /* regenerator-runtime/runtime */);
      ...
      class Species3 {
        constructor(setup) {
          ...
          this.maxYoungsters = this.getRoundedNumber(this.maxCycles * this.litterSize, 0);
        ...
        addToPopulation = (amount, mature, age) => {
          for (let index = 0; index < amount; index++) {
            ...
            this.population.push(new default3({
              age: currentAge,
              isMature: mature
            }));
            this.breeds += 1;
      ...
      class LiveFoodCalculator2 {
        ...
        runSimulation = () => {
          ...
          this.species.forEach((speciesSingular) => {
            this.speciesObjects.push(new default4({
        ...
        renderCanvas = () => {
          ...
          this.weeks.forEach((week) => {
            week.forEach((speciesObject, speciesObjectKey) => {
              if (speciesObjectKey in maxPopulations) {
                if (maxPopulations[speciesObjectKey] > speciesObject.population.length) {
                  return;
                }
              }
          ...
          this.canvasEngine.ctx.strokeStyle = "#" + ((1 << 24) * Math.random() | 0).toString(16);
          ...
          this.weeks.forEach((week, weekKey) => {
            ...
            week.forEach((speciesObject, speciesObjectKey) => {
              ...
              this.canvasEngine.drawLine({
                ...
                y: canvasHeight - canvasHeight / maxPopulations[speciesObjectKey] * speciesObject.population.length
              });
            });
          });
        };
        renderOverview = () => {
          ...
          lastWeek.forEach((speciesObject) => {
            ...
            <p class="result__reportRow ${speciesObject.missingOffspring > this.weeks.length / 10 ? "result__reportRow--bad" : ""}">
              <span>Wochen mit zu wenig Futtertieren:</span> ${speciesObject.missingOffspring}</p>
            <p class="result__reportRow">
      ...
      const default5 = LiveFoodCalculator2;
      ...
      document.addEventListener("DOMContentLoaded", function() {
        const testInstance = new default5();
      });
    }
  };
  return __require(4);
